    ...
    <div className="container mx-auto px-4 py-8">
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>portfoliopilot.in is a digital service that provides portfolio building tools for developers. As such, we do not ship physical products or have a traditional delivery process.</p>
          ...
          <p>Once you create and publish your portfolio, it will be immediately available at your custom URL (portfoliopilot.in/username).</p>
          ...
          <h2>6. Contact Us</h2>
          <p>If you have any questions about accessing our service or your portfolio, please contact us at support@portfoliopilot.in.</p>
        </CardContent>
      </Card>
    </div>
  )
