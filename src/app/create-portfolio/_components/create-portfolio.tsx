    ...
    startTransition(async () => {
      ...
      if (!Boolean(existingRoute?.routeName ?? 0)) {
        ...
        try {
          ...
          console.log(isRouteAdded, "isRouteAdded");

          if (!isRouteAdded) {
            await toast.promise(
              Promise.reject(),
              {
                loading: "Checking route availability...",
                error: "Failed to add route. Please try a different route name.",
              }
            );
            return;
          }
      ...
      try {
        await toast.promise(
          addHeroSection(heroSectionData, existingRoute?.routeName || ""),
          {
            loading: "Creating portfolio...",
            success: "Portfolio created successfully.",
            error: "Error creating portfolio. Please try again.",
          }
        );
      } catch (error) {
                    ...
                    <FormItem>
                      <FormLabel>
                        ...
                        <span className="text-muted-foreground">
                          https://portfoliopilot.in/{routeForm.getValues("routeName")?routeForm.getValues("routeName"):'portfolio-name'}
                        </span>
                        ]
                      </FormLabel>
