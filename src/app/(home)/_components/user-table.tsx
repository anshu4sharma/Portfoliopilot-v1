...
import { GetAllUsersType } from "@/actions/user-actions";
    ...
    <div className="w-full max-w-full sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex flex-col items-center gap-2 sm:items-start">
          <h2 className="text-2xl font-bold md:text-3xl">Portfolio Explorer</h2>
          <p className="text-center text-lg text-muted-foreground sm:text-left">
            ...
            others who have created their professional portfolios
          </p>
        </div>
                ...
                <TableRow key={i}>
                  ...
                  <TableCell className="py-2">
                    <div className="flex items-center gap-2">
                      ...
                      {user?.userType === "pro" && <Badge>Pro</Badge>}
                    </div>
                  </TableCell>
                </TableRow>
              ))}
